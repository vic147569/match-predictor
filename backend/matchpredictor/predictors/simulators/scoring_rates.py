...
class ScoringRates:
    ...
    def __add_result(self, result: Result) -> None:
        home_team_scoring = self.scoring_dict.get(
            result.fixture.home_team, TeamScoring(0, 0, 0)
        )
        ...
        away_team_scoring = self.scoring_dict.get(
            result.fixture.away_team, TeamScoring(0, 0, 0)
        )
